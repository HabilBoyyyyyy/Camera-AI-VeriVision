...
export default function LoginPage() {
  ...
  if (loading)
    return (
      <div
        ...
        style={{background: dark ? "#060d1a" : "#f0f6ff"}}>
        <div
  ...
  /* ── Colours change with theme (unchanged palette) ── */
  ...
  // Bracket (viewfinder) accent — echoes the machine-vision subject matter
  const bracketColor = dark ? "rgba(56,139,253,0.55)" : "rgba(56,139,253,0.55)";
  ...
  return (
    <div
      ...
      <div
        className="relative w-full lg:w-[42%] flex flex-col justify-between overflow-hidden px-8 py-10 lg:px-14 lg:py-14"
        style={{
          borderBottom: dark
        ...
        {/* Fade overlay — keeps text readable, adapts to theme */}
        <div
          className="absolute inset-0 z-10"
          style={{
            background: dark
              ? "rgba(6,13,26,0.80)" // matches your dark `bg` value
              : "rgba(240,246,255,0.82)", // matches your light `bg` value
          }}
        />

        {/* Grid texture — kept on top of the photo, now more subtle */}
        <div
          className="absolute inset-0 z-10 pointer-events-none"
          style={{
            backgroundImage: dark
              ? `linear-gradient(rgba(56,139,253,.06) 1px, transparent 1px), linear-gradient(90deg, rgba(56,139,253,.06) 1px, transparent 1px)`
              : `linear-gradient(rgba(56,139,253,.05) 1px, transparent 1px), linear-gradient(90deg, rgba(56,139,253,.05) 1px, transparent 1px)`,
            backgroundSize: "56px 56px",
          }}
        />
        {/* Top row: logo mark + system status */}
          ...
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                ...
                border: `1px solid ${dark ? "rgba(56,139,253,0.22)" : "rgba(56,139,253,0.18)"}`,
              }}>
              ...
              <img
                ...
                style={{
                  filter: dark
                    ? "brightness(1) drop-shadow(0 0 6px rgba(56,139,253,0.4))"
                    : "none",
                }}
              />
            </div>
        ...
        {/* Middle: big wordmark, vertically weighted */}
        <div className="relative z-20 my-10 lg:my-0">
          <h1
            className="font-black leading-[0.92] tracking-[0.02em]"
            style={{
              color: titleColor,
          ...
          <p
            ...
            Secure Access Required. Authenticate to enter the inspection
            console.
          </p>
        </div>

        {/* Bottom: decorative scan ticks */}
        <div className="relative z-20 hidden lg:flex items-end gap-1.5 h-10">
          {[6, 14, 9, 22, 12, 28, 10, 18, 8, 24, 13, 7].map((h, i) => (
            <span
              key={i}
      ...
      {/* ══════════════ RIGHT — Auth panel ══════════════ */}
      <div className="relative flex-1 flex items-center justify-center px-5 py-12 lg:py-0">
        {/* Theme toggle */}
        ...
        {/* Viewfinder-framed form — corner brackets replace the old card box */}
        <div className="relative w-full max-w-[380px] animate-fade-in">
            ...
            <span
              ...
              style={{
                ...
                borderTop: pos.borderTop
                  ? `${pos.borderTop}px solid ${bracketColor}`
                  : "none",
                borderLeft: pos.borderLeft
                  ? `${pos.borderLeft}px solid ${bracketColor}`
                  : "none",
                borderRight: pos.borderRight
                  ? `${pos.borderRight}px solid ${bracketColor}`
                  : "none",
                borderBottom: pos.borderBottom
                  ? `${pos.borderBottom}px solid ${bracketColor}`
                  : "none",
              }}
            />
          ))}
          ...
          <div
            ...
            {/* Eyebrow label instead of centered brand block */}
            <p
              className="text-[11px] font-semibold uppercase tracking-[0.16em] mb-6"
              style={{color: "#388bfd"}}>
              Operator Sign-In
            </p>
                  ...
                  <input
                    ...
                    onFocus={(e) => {
                      ...
                      e.target.style.boxShadow =
                        "0 0 0 3px rgba(56,139,253,0.12)";
                    }}
                    onBlur={(e) => {
