    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 stagger-2">
        {loading
          ? [1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="vv-card p-5 h-24 animate-pulse"
      ...
      <div className="stagger-3 space-y-4">
        ...
        {!loading && (
          <div className="vv-card flex flex-col overflow-hidden">
            <div
              className="p-4 shrink-0 flex justify-between items-center"
              style={{
              ...
              {displayedAlerts.length > 0 ? (
                displayedAlerts.map((alert, i) => {
                  ...
                  return (
                    <div
                      key={alert.id || i}
                      className="p-4 flex items-start gap-4 transition-colors relative hover:bg-[var(--clr-surface-low)]"
                      ...
                      <button
                        ...
                        className="text-xs btn-outline px-2 py-1 flex items-center gap-1 opacity-60 hover:opacity-100">
                        <span className="material-symbols-outlined text-[14px]">
                          check
                        </span>
                        Acknowledge
      ...
      <div className="vv-card overflow-hidden flex flex-col stagger-4">
        <div
          ...
          <h3
            ...
            style={{color: "var(--clr-text)"}}>
            Live Inspection Feed: Line Alpha
          </h3>
          <div className="flex items-center gap-2">
        ...
        <div
          className="relative min-h-[300px] flex-1 flex items-center justify-center"
          style={{background: "var(--clr-surface-mid)"}}>
          <div className="text-center" style={{color: "var(--clr-text-muted)"}}>
            <span className="material-symbols-outlined text-[56px] block mb-3 opacity-30">
              videocam_off
            </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 stagger-6">
        ...
        {summary?.recent_ng_parts?.length > 0 ? (
          ...
          <div
            className="vv-card overflow-hidden flex flex-col items-center justify-center p-6 text-center text-xs"
            style={{color: "var(--clr-text-muted)"}}>
            <span className="material-symbols-outlined text-[48px] block mb-3 opacity-30">
              verified
            </span>
