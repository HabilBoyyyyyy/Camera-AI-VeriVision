  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          <h2 className="text-xl font-bold" style={{ color: "var(--clr-text)" }}>Integrations</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
        ...
        <div className="lg:col-span-3 space-y-4">
          <h4 className="text-sm font-semibold uppercase tracking-wider" style={{ color: "var(--clr-text-sub)" }}>
        ...
        <div className="lg:col-span-2 flex flex-col">
          <h4 className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: "var(--clr-text-sub)" }}>
          ...
          {/* Event History */}
          <div className="mt-4">
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-3" style={{ color: "var(--clr-text-sub)" }}>
...
export default function ConfigurationPage() {
  ...
  return (
    <div className="animate-fade-in max-w-7xl mx-auto space-y-6 pb-8">
      {/* Page Header */}
      <div>
        <h1 className="text-2xl font-bold" style={{ color: "var(--clr-text)" }}>Configuration</h1>
        <p className="text-sm mt-1" style={{ color: "var(--clr-text-sub)" }}>
      ...
      {/* Tabs */}
      <div className="flex gap-1 p-1 rounded-lg w-max" style={{background:'var(--clr-surface-low)'}}>
        {tabs.map(tab => (
          <button key={tab.id}
